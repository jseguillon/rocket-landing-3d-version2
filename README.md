...
Screenshots are generated by the CI Playwright pipeline and saved under `qa-artifacts/screenshots/`. Visual pixel analysis reports are generated in `qa-artifacts/visual-report.json` and `qa-artifacts/visual-report.md`.
